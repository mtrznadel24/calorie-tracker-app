...
const FridgeProductsScreen = () => {
  ...
  const [products, setProducts] = useState([
    { id: 1, name: 'Apple', category: 'fruits', isFavourite: true, calories_100g: 52, proteins_100g: 0.3, fats_100g: 0.2, carbs_100g: 14 },
    { id: 2, name: 'Chicken Breast', category: 'meat and fish', isFavourite: false, calories_100g: 165, proteins_100g: 31, fats_100g: 3.6, carbs_100g: 0 },
    { id: 3, name: 'Greek Yogurt', category: 'dairy', isFavourite: false, calories_100g: 59, proteins_100g: 10, fats_100g: 0.4, carbs_100g: 3.6 },
    { id: 4, name: 'Banana', category: 'fruits', isFavourite: false, calories_100g: 89, proteins_100g: 1.1, fats_100g: 0.3, carbs_100g: 23 },
    { id: 5, name: 'Broccoli', category: 'vegetables', isFavourite: true, calories_100g: 34, proteins_100g: 2.8, fats_100g: 0.4, carbs_100g: 7 },
  ]);
      ...
      <FlatList
        ...
        renderItem={({ item }) => (
          <ProductCard
            ...
            onToggleFavourite={() => console.log('Clicked heart icon ID:', item.id)}
