        ...
        <View className="flex-row items-center gap-3">
          <View className="flex-row gap-3 mr-1">
            <View className="items-center">
              <Text className="text-[10px] font-bold text-blue-600 dark:text-blue-400 mb-0.5">
                P
              </Text>
            ...
            <View className="items-center">
              <Text className="text-[10px] font-bold text-yellow-500 dark:text-yellow-400 mb-0.5">
                F
              </Text>
              <Text className="text-sm font-semibold text-text-dark dark:text-text-light">
                {fats.toFixed(0)}
            ...
            <View className="items-center">
              <Text className="text-[10px] font-bold text-[#8B4513] dark:text-[#CD853F] mb-0.5">
                C
              </Text>
              <Text className="text-sm font-semibold text-text-dark dark:text-text-light">
                {carbs.toFixed(0)}
