...
def add_fridge_product_route(
    fridge_id: int, product_in: FridgeProductCreate, db: Session = Depends(get_db)
):
...
def read_fridge_product_route(
    fridge_id: int, product_id: int, db: Session = Depends(get_db)
):
...
def add_fridge_meal_route(
    fridge_id: int, meal_in: FridgeMealCreate, db: Session = Depends(get_db)
):
...
def delete_fridge_meal_route(
    fridge_id: int, meal_id: int, db: Session = Depends(get_db)
):
...
def read_fridge_meal_ingredient_route(
    fridge_id: int, meal_id: int, ingredient_id: int, db: Session = Depends(get_db)
):
