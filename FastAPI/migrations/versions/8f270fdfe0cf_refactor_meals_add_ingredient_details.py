...
down_revision: str | Sequence[str] | None = "43c72f647236"
...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_fridge_meal_ingredients_fridge_meal_id"),
        "fridge_meal_ingredients",
        ["fridge_meal_id"],
        unique=False,
    )
    op.drop_constraint(
        op.f("fridge_meal_ingredients_fridge_meal_id_fkey"),
        "fridge_meal_ingredients",
        type_="foreignkey",
    )
    op.drop_constraint(
        op.f("fridge_meal_ingredients_fridge_product_id_fkey"),
        "fridge_meal_ingredients",
        type_="foreignkey",
    )
    ...
    op.alter_column(
        "fridge_meals", "fridge_id", existing_type=sa.INTEGER(), nullable=False
    )
    op.alter_column("fridge_meals", "name", existing_type=sa.VARCHAR(), nullable=False)
    op.create_index(
        op.f("ix_fridge_meals_fridge_id"), "fridge_meals", ["fridge_id"], unique=False
    )
    op.create_index(
        op.f("ix_fridge_meals_is_favourite"),
        "fridge_meals",
        ["is_favourite"],
        unique=False,
    )
    op.create_index(
        op.f("ix_fridge_meals_name"), "fridge_meals", ["name"], unique=False
    )
    op.create_unique_constraint(
        "un_fridge_meal_name", "fridge_meals", ["fridge_id", "name"]
    )
    op.drop_constraint(
        op.f("fridge_meals_fridge_id_fkey"), "fridge_meals", type_="foreignkey"
    )
    op.create_foreign_key(
        None, "fridge_meals", "fridges", ["fridge_id"], ["id"], ondelete="CASCADE"
    )
    op.alter_column(
        "fridge_products", "fridge_id", existing_type=sa.INTEGER(), nullable=False
    )
    op.alter_column(
        "fridge_products", "product_name", existing_type=sa.VARCHAR(), nullable=False
    )
    op.alter_column(
        "fridge_products",
        "calories_100g",
    ...
    op.create_index(
        op.f("ix_fridge_products_fridge_id"),
        "fridge_products",
        ["fridge_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_fridge_products_is_favourite"),
        "fridge_products",
        ["is_favourite"],
        unique=False,
    )
    op.create_index(
        op.f("ix_fridge_products_product_name"),
        "fridge_products",
        ["product_name"],
        unique=False,
    )
    op.create_unique_constraint(
        "un_fridge_product_name", "fridge_products", ["fridge_id", "product_name"]
    )
    op.drop_constraint(
        op.f("fridge_products_fridge_id_fkey"), "fridge_products", type_="foreignkey"
    )
    op.create_foreign_key(
        None, "fridge_products", "fridges", ["fridge_id"], ["id"], ondelete="CASCADE"
    )
    op.alter_column("fridges", "user_id", existing_type=sa.INTEGER(), nullable=False)
    ...
    op.create_foreign_key(
        None, "fridges", "users", ["user_id"], ["id"], ondelete="CASCADE"
    )
    op.alter_column(
        "meal_ingredients",
        "weight",
    ...
    op.alter_column(
        "meal_ingredients", "meal_id", existing_type=sa.INTEGER(), nullable=False
    )
    op.create_index(
    ...
    op.drop_constraint(
        op.f("meal_ingredients_meal_id_fkey"), "meal_ingredients", type_="foreignkey"
    )
    op.drop_constraint(
        op.f("meal_ingredients_fridge_product_id_fkey"),
        "meal_ingredients",
        type_="foreignkey",
    )
    op.create_foreign_key(
        None, "meal_ingredients", "meals", ["meal_id"], ["id"], ondelete="CASCADE"
    )
    op.drop_column("meal_ingredients", "fridge_product_id")
    op.alter_column("meals", "user_id", existing_type=sa.INTEGER(), nullable=False)
    op.alter_column(
        "meals",
        "date",
    ...
    op.create_foreign_key(
        None, "meals", "users", ["user_id"], ["id"], ondelete="CASCADE"
    )
    op.drop_column("meals", "fridge_meal_id")
    op.alter_column(
        "measurements", "user_id", existing_type=sa.INTEGER(), nullable=False
    )
    op.alter_column(
        "measurements",
        "date",
    ...
    op.create_index(
        op.f("ix_measurements_date"), "measurements", ["date"], unique=False
    )
    op.create_index(
        op.f("ix_measurements_user_id"), "measurements", ["user_id"], unique=False
    )
    op.drop_constraint(
        op.f("measurements_user_id_fkey"), "measurements", type_="foreignkey"
    )
    op.drop_constraint(
        op.f("measurements_weight_id_fkey"), "measurements", type_="foreignkey"
    )
    op.create_foreign_key(
        None, "measurements", "weights", ["weight_id"], ["id"], ondelete="SET NULL"
    )
    op.create_foreign_key(
        None, "measurements", "users", ["user_id"], ["id"], ondelete="CASCADE"
    )
    ...
    op.alter_column("weights", "user_id", existing_type=sa.INTEGER(), nullable=False)
    op.alter_column(
        "weights",
        "date",
        existing_type=postgresql.TIMESTAMP(),
    ...
    op.create_foreign_key(
        None, "weights", "users", ["user_id"], ["id"], ondelete="CASCADE"
    )
...
def downgrade() -> None:
    ...
    op.create_foreign_key(
        op.f("weights_user_id_fkey"), "weights", "users", ["user_id"], ["id"]
    )
    ...
    op.alter_column("weights", "user_id", existing_type=sa.INTEGER(), nullable=True)
    ...
    op.drop_constraint(None, "measurements", type_="foreignkey")
    op.create_foreign_key(
        op.f("measurements_weight_id_fkey"),
        "measurements",
        "weights",
        ["weight_id"],
        ["id"],
    ...
    op.create_foreign_key(
        op.f("measurements_user_id_fkey"), "measurements", "users", ["user_id"], ["id"]
    )
    ...
    op.alter_column(
        "measurements", "user_id", existing_type=sa.INTEGER(), nullable=True
    )
    op.add_column(
        "meals",
        sa.Column("fridge_meal_id", sa.INTEGER(), autoincrement=False, nullable=True),
    )
    op.drop_constraint(None, "meals", type_="foreignkey")
    op.create_foreign_key(
        op.f("meals_user_id_fkey"), "meals", "users", ["user_id"], ["id"]
    )
    op.create_foreign_key(
        op.f("meals_fridge_meal_id_fkey"),
        "meals",
        "fridge_meals",
        ["fridge_meal_id"],
        ["id"],
    ...
    op.alter_column("meals", "user_id", existing_type=sa.INTEGER(), nullable=True)
    op.add_column(
        "meal_ingredients",
        sa.Column(
            "fridge_product_id", sa.INTEGER(), autoincrement=False, nullable=True
        ),
    )
    ...
    op.create_foreign_key(
        op.f("meal_ingredients_meal_id_fkey"),
        "meal_ingredients",
        "meals",
        ["meal_id"],
        ["id"],
    ...
    op.alter_column(
        "meal_ingredients", "meal_id", existing_type=sa.INTEGER(), nullable=True
    )
    op.alter_column(
        "meal_ingredients",
        "weight",
    ...
    op.create_foreign_key(
        op.f("fridges_user_id_fkey"), "fridges", "users", ["user_id"], ["id"]
    )
    op.drop_index(op.f("ix_fridges_user_id"), table_name="fridges")
    op.alter_column("fridges", "user_id", existing_type=sa.INTEGER(), nullable=True)
    op.drop_constraint(None, "fridge_products", type_="foreignkey")
    op.create_foreign_key(
        op.f("fridge_products_fridge_id_fkey"),
        "fridge_products",
        "fridges",
        ["fridge_id"],
        ["id"],
    ...
    op.alter_column(
        "fridge_products", "product_name", existing_type=sa.VARCHAR(), nullable=True
    )
    op.alter_column(
        "fridge_products", "fridge_id", existing_type=sa.INTEGER(), nullable=True
    )
    op.drop_constraint(None, "fridge_meals", type_="foreignkey")
    op.create_foreign_key(
        op.f("fridge_meals_fridge_id_fkey"),
        "fridge_meals",
        "fridges",
        ["fridge_id"],
        ["id"],
    ...
    op.alter_column("fridge_meals", "name", existing_type=sa.VARCHAR(), nullable=True)
    op.alter_column(
        "fridge_meals", "fridge_id", existing_type=sa.INTEGER(), nullable=True
    )
    ...
    op.drop_index(
        op.f("ix_fridge_meal_ingredients_fridge_meal_id"),
        table_name="fridge_meal_ingredients",
    )
    op.alter_column(
        "fridge_meal_ingredients",
        "fridge_product_id",
