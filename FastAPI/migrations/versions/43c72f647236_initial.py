...
def upgrade() -> None:
    ...
    op.create_table('fridge_products',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('fridge_id', sa.Integer(), nullable=True),
    ...
    sa.Column('category', sa.Enum('FRUIT', 'VEGETABLE', 'GRAINS', 'DAIRY', 'MEAT_FISH', 'PLANT_PROTEIN', 'FATS', 'DRINKS', 'SNACKS', name='food_category'), nullable=True),
    sa.Column('is_favourite', sa.Boolean(), nullable=False),
    sa.ForeignKeyConstraint(['fridge_id'], ['fridges.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    op.create_index(op.f('ix_fridge_products_id'), 'fridge_products', ['id'], unique=False)
    ...
    op.create_table('fridge_meal_ingredients',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('weight', sa.Float(), nullable=True),
    sa.Column('fridge_meal_id', sa.Integer(), nullable=True),
    sa.Column('fridge_product_id', sa.Integer(), nullable=True),
    sa.ForeignKeyConstraint(['fridge_meal_id'], ['fridge_meals.id'], ),
    sa.ForeignKeyConstraint(['fridge_product_id'], ['fridge_products.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    op.create_index(op.f('ix_fridge_meal_ingredients_id'), 'fridge_meal_ingredients', ['id'], unique=False)
    op.create_table('meals',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('user_id', sa.Integer(), nullable=True),
    sa.Column('fridge_meal_id', sa.Integer(), nullable=True),
    sa.Column('date', sa.DateTime(), nullable=True),
    sa.Column('type', sa.Enum('BREAKFAST', 'LUNCH', 'DINNER', 'SNACK', 'SUPPER', name='meal_type'), nullable=False),
    sa.ForeignKeyConstraint(['fridge_meal_id'], ['fridge_meals.id'], ),
    sa.ForeignKeyConstraint(['user_id'], ['users.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
...
def downgrade() -> None:
    ...
    op.drop_table('meals')
    op.drop_index(op.f('ix_fridge_meal_ingredients_id'), table_name='fridge_meal_ingredients')
